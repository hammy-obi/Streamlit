# -*- coding: utf-8 -*-
"""Fashion MNIST using CNN.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1rdJWUvLcn40qbkgFdZqmnpZYrBIIgii-
"""
...
# prompt: Push this model on Streamlit
...
# Assume 'network' is the trained model from the previous code
...
if uploaded_file is not None:
  ...
  # ... (add image preprocessing code)

  # Make prediction
  # prediction = model.predict(processed_image) # Example using a loaded model
  # Use the 'network' model from the previous code
  # prediction = network.predict(processed_image)  # Assuming 'network' is defined
  ...
  # Example:
  # st.write("Prediction:", prediction) # Adapt the display to your model's output
...
if uploaded_file is not None:
  ...
  processed_image = processed_image.reshape(1, 28, 28, 1) # Reshape to match model input

  # Make prediction
  prediction = network.predict(processed_image)  # Assuming 'network' is defined

  # Display results
  st.image(opencv_image, caption="Uploaded Image", use_column_width=True)  # Display original image
  st.write("Prediction:", prediction)  # Adapt the display to your model's output

from pyngrok import ngrok
ngrok.set_auth_token("2rPTDBj3bY9IGjRLhr2igKwhPoC_2gswxqA9K19e8VEK9MqAQ")

# Setup a tunnel to the Streamlit port 8501
tunnel = ngrok.connect(addr="8501", proto="http") # or proto="tcp"
# or proto="tls", if your Streamlit app is configured with TLS

# Get the public URL from the tunnel object
